...
namespace Alex.API.Gui
{
    public class GuiDebugHelper
    {
        ...
        {
            if (!Enabled) return;
            var isTopmost = element == TopMostHighlighted;
            ...
            {
                DrawDebugBounds(element.RenderBounds, Color.Blue, false, true, true, true);
            }
            ...
            // cursor highlight 
            {
                ...
                {
                    DrawDebugBounds(element.OuterBounds, Color.OrangeRed, isTopmost, true, false, false);
                }

                if (element.Bounds.Contains(CursorPosition))
                {
                    DrawDebugBounds(element.Bounds, Color.Red, isTopmost, true, false, true, true);
                    if(isTopmost)
                ...
                if (element.Bounds.Contains(CursorPosition))
                {
                    DrawDebugBounds(element.InnerBounds, Color.MediumVioletRed, isTopmost, true, false, false);
                }
            }
        ...
        private void DrawDebugBounds(Rectangle bounds, Color color, bool drawBackground = false, bool drawBorders = true, bool drawCoordinates = true, bool drawSize = true, bool highlight = false)
        {
            // Bounding Rectangle
            if (drawBackground)
            {
