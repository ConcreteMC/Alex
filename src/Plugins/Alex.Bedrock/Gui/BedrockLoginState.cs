...
namespace Alex.Bedrock.Gui
{
    public class BedrockLoginState : GuiMenuStateBase
    {
        ...
        public BedrockLoginState(GuiPanoramaSkyBox skyBox, Action<PlayerProfile> readyAction, XBLMSAService xblmsaService)
        {
            Title = "Bedrock Login";
            AuthenticationService = xblmsaService;
