...
using Alex.Bedrock.Gui.Forms;
using Alex.Bedrock.Net.Raknet;
using Alex.Entities;
using Alex.Net;
...
namespace Alex.Bedrock.Worlds
{
	public class BedrockWorldProvider : WorldProvider
	{
		...
		public BedrockWorldProvider(BedrockPlugin plugin, Alex alex, IPEndPoint endPoint, PlayerProfile profile, DedicatedThreadPool threadPool,
			out NetworkProvider networkProvider)
		{
			...
			Client = new BedrockClient(plugin, alex, eventDispatcher, endPoint, profile, threadPool, this);
