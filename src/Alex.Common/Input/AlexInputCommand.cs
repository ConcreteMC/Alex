...
namespace Alex.Common.Input
{
	public static class AlexInputCommand
	{
		...
		[InputCommandDescriptor("key.forward")]
		...
		[InputCommandDescriptor("key.back")]
		...
		[InputCommandDescriptor("key.jump", InputCommandType.Controller)]
		public static readonly InputCommand Jump = new(AlexNamespace, nameof(Jump));

		[InputCommandDescriptor("key.sneak", InputCommandType.Controller)]
		public static readonly InputCommand Sneak = new(AlexNamespace, nameof(Sneak));

		[InputCommandDescriptor("key.sprint")]
		public static readonly InputCommand Sprint = new(AlexNamespace, nameof(Sprint));

		[InputCommandDescriptor("key.sprint", InputCommandType.Controller)]
		public static readonly InputCommand SprintToggle = new(AlexNamespace, nameof(SprintToggle));

		[InputCommandDescriptor("key.drop")]
		...
		[InputCommandDescriptor("key.keyboard.f3")]
		public static readonly InputCommand ToggleDebugInfo = InputCommand.ToggleDebugInfo;

		[InputCommandDescriptor("")] public static readonly InputCommand ToggleBoundingboxDebugInfo =
			new(AlexNamespace, nameof(ToggleBoundingboxDebugInfo));

		[InputCommandDescriptor("")]
		public static readonly InputCommand ToggleNetworkDebugInfo = new(AlexNamespace, nameof(ToggleNetworkDebugInfo));

		[InputCommandDescriptor("key.chat")]
		public static readonly InputCommand ToggleChat = new(AlexNamespace, nameof(ToggleChat));

		[InputCommandDescriptor("key.togglePerspective")]
		public static readonly InputCommand ToggleCamera = new(AlexNamespace, nameof(ToggleCamera));

		[InputCommandDescriptor("key.screenshot")]
		public static readonly InputCommand TakeScreenshot = new(AlexNamespace, nameof(TakeScreenshot));
		...
		[InputCommandDescriptor("key.inventory")]
		...
		[InputCommandDescriptor("", InputCommandType.Mouse)]
		...
		[InputCommandDescriptor("gui.up", InputCommandType.Controller)]
		public static readonly InputCommand NavigateUp = InputCommand.NavigateUp;

		[InputCommandDescriptor("gui.down", InputCommandType.Controller)]
		...
		[InputCommandDescriptor("gui.ok", InputCommandType.Controller)]
		public static readonly InputCommand Navigate = InputCommand.Navigate;

		[InputCommandDescriptor("gui.back", InputCommandType.Controller)]
		public static readonly InputCommand NavigateBack = InputCommand.NavigateBack;

		[InputCommandDescriptor("")]
		public static readonly InputCommand ToggleMap = new(AlexNamespace, nameof(ToggleMap));
		...
		public static InputCommandWrapper[] GetAll()
		{
			var props = typeof(AlexInputCommand).GetFields(BindingFlags.Public | BindingFlags.Static)
			   .Where(p => p.FieldType == typeof(InputCommand)).ToArray();
