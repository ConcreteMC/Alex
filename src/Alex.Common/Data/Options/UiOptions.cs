...
namespace Alex.Common.Data.Options
{
	...
	{
		[DataMember] public MinimapOptions Minimap { get; set; }

		[DataMember] public ScoreboardOptions Scoreboard { get; set; }

		[DataMember] public ChatOptions Chat { get; set; }
	...
	{
		[DataMember] public OptionsProperty<bool> Enabled { get; set; }

		[DataMember] public OptionsProperty<int> MessageHistory { get; set; }

		public ChatOptions()
		{
			Enabled = DefineProperty(true);
			MessageHistory = DefineProperty(10, (value, newValue) => { return Math.Clamp(value, 0, 100); });
		}
	}
	...
	public class ScoreboardOptions : OptionsBase
	{
		...
		[DataMember] public OptionsProperty<ElementPosition> Position { get; set; }

		[DataMember] public OptionsProperty<bool> ShowScore { get; set; }

		public ScoreboardOptions()
		{
			Enabled = DefineProperty(true);

			Position = DefineProperty(
				ElementPosition.Default, (value, newValue) =>
				{
	...
	public class MinimapOptions : OptionsBase
	{
		...
		[DataMember] public OptionsProperty<double> Size { get; set; }

		[DataMember] public OptionsProperty<ZoomLevel> DefaultZoomLevel { get; set; }

		[DataMember] public OptionsProperty<bool> AlphaBlending { get; set; }
