...
namespace Alex.Common.Data.Options
{
    ...
    {
        [DataMember]
        public OptionsProperty<int> NetworkThreads { get; set; }
        
        [DataMember]
        public OptionsProperty<long> InactivityTimeout { get; set; } 
        
        [DataMember]
        public OptionsProperty<int> ResendThreshold { get; set; }
