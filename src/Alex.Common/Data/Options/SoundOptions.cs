...
namespace Alex.Common.Data.Options
{
    ...
    public class SoundOptions : OptionsBase
    {
        ...
        [DataMember]
        public OptionsProperty<double> AmbientVolume { get; set; }
        
        [DataMember]
        public OptionsProperty<double> BlocksVolume { get; set; }

        [DataMember]
        public OptionsProperty<double> PlayerVolume { get; set; }
        
        [DataMember]
        public OptionsProperty<double> NeutralVolume { get; set; }
        
        [DataMember]
        public OptionsProperty<double> HostileVolume { get; set; }
        
        [DataMember]
        public OptionsProperty<double> WeatherVolume { get; set; }
        
        [DataMember]
        public OptionsProperty<double> RecordVolume { get; set; }
