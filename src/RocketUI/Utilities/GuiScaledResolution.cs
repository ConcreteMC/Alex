...
namespace RocketUI.Utilities
{
	...
	public class GuiScaledResolution
	{
		...
		private int _targetWidth = 320*2;
		...
		private int _targetHeight = 240*2;
		...
		public void Update()
		{
			...
			var scaledWidth  = MathUtils.IntCeil(scaledWidthD);
			var scaledHeight = MathUtils.IntCeil(scaledHeightD);
