...
#pragma warning restore IDE1006 // Naming Styles
        ...
        public static void Initialize(bool setDefault = true)
        {
            ...
            Markup.FontImage.RegisterFont("FontAwesome", new FontFamily(new Uri($"pack://application:,,,/{typeof(FontAwesome).Assembly.GetName().Name};component/Resources/Fonts/", UriKind.RelativeOrAbsolute), "./#FontAwesome"));
            if (setDefault)
                Markup.FontImage.DefaultFontFamily = "FontAwesome";

            Orchestra.Markup.FontImage.RegisterFont("FontAwesome", new FontFamily(new Uri($"pack://application:,,,/{typeof(FontAwesome).Assembly.GetName().Name};component/Resources/Fonts/", UriKind.RelativeOrAbsolute), "./#FontAwesome"));
            if (setDefault)
