...
namespace Alex.Utils.Collections.Queue
{
	...
	/// </summary>
	public class ConcurrentPriorityQueue<TElement, TPriority> : AbstractPriorityQueue<TElement, TPriority>
		where TPriority : IComparable<TPriority>
	{
		...
		private ConcurrentPriorityQueue(Node[] nodes, int count, NodeComparer comparer) :
			base(nodes, count, comparer) { }
		...
		public override IEnumerator<TElement> GetEnumerator()
		{
			...
			var queueCopy = new ConcurrentPriorityQueue<TElement, TPriority>(
				nodesCopy, nodesCopy.Length - 1, _comparer);
