...
namespace Alex.Utils.Assets
{
	...
	public partial class AssetIndex
	{
		public static AssetIndex FromJson(string json) =>
			JsonConvert.DeserializeObject<AssetIndex>(json, AssetIndexConverter.Settings);
	}

	public static class AssetIndexSerialize
	{
		public static string ToJson(this AssetIndex self) =>
			JsonConvert.SerializeObject(self, AssetIndexConverter.Settings);
	}
