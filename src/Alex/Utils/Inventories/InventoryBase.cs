...
namespace Alex.Utils.Inventories
{
	public class InventoryBase
	{
		...
		public void Empty()
		{
			...
			{
				Slots[i] = new ItemAir() { Count = 0 };
			}

			_cursor = new ItemAir() { Count = 0 };
		}
		...
		public virtual void SetCursor(Item item,
			...
			MouseButton button = MouseButton.Left)
		{
			...
			InvokeCursorChanged(
				new CursorChangedEventArgs(InventoryId, index, item, oldValue, isServerTransaction, button));
		}
