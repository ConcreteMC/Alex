...
namespace Alex.Blocks.Materials
{
    public class Material : IMaterial
	{
		...
		public static readonly IMaterial Grass = new Material(Utils.MapColor.Grass).WithTintType(TintType.Grass).WithHardness(0.6f).WithSoundCategory("grass");
		public static readonly IMaterial Ground = new Material(Utils.MapColor.Dirt).WithHardness(0.5f);
		public static readonly IMaterial Wood = (new Material(Utils.MapColor.Wood)).SetFlammable().WithHardness(2f).WithSoundCategory("wood");
		public static readonly IMaterial Wool = (new Material(Utils.MapColor.Clay)).SetFlammable().WithHardness(0.8f).WithSoundCategory("wool");
		...
		public static readonly IMaterial Ore = new Material(Utils.MapColor.Stone).SetRequiresTool().SetRequiredTool(ItemType.PickAxe, ItemMaterial.Any).WithHardness(3);
		
		public static readonly IMaterial Iron = (new Material(Utils.MapColor.Iron)).SetRequiresTool().WithHardness(5f).WithSoundCategory("metal");
		...
		public static readonly IMaterial Lava = (new MaterialLiquid(Utils.MapColor.Tnt));
		public static readonly IMaterial Leaves = (new Material(Utils.MapColor.Foliage)).WithTintType(TintType.Foliage).SetFlammable().WithHardness(0.2f);
		
		public static readonly IMaterial Plants = (new MaterialLogic(Utils.MapColor.Foliage)).WithTintType(TintType.Foliage).WithHardness(0.6f);
		
		public static readonly IMaterial Vine = (new MaterialLogic(Utils.MapColor.Foliage)).WithTintType(TintType.Foliage).SetFlammable().SetReplaceable().WithHardness(0.2f);
		...
		public static readonly IMaterial Fire = (new MaterialTransparent(Utils.MapColor.Air));
		public static readonly IMaterial Sand = new Material(Utils.MapColor.Sand);
		public static readonly IMaterial Circuits = (new MaterialLogic(Utils.MapColor.Air)).WithHardness(0.2f);
		public static readonly IMaterial Carpet = (new MaterialLogic(Utils.MapColor.Cloth)).SetFlammable().WithHardness(0.1f);
		...
		public static readonly IMaterial Tnt = (new Material(Utils.MapColor.Tnt)).SetFlammable();
		public static readonly IMaterial Coral = (new Material(Utils.MapColor.Foliage));
		public static readonly IMaterial Ice = (new Material(Utils.MapColor.Ice)).SetTranslucent().WithSlipperiness(0.98d);
		public static readonly IMaterial BlueIce = (new Material(Utils.MapColor.Ice)).SetTranslucent().WithSlipperiness(0.989d);
		public static readonly IMaterial PackedIce = (new Material(Utils.MapColor.Ice)).WithSlipperiness(0.989d);
		public static readonly IMaterial Snow = (new MaterialLogic(Utils.MapColor.Snow)).SetReplaceable().SetRequiresTool().WithTintType(TintType.Color, Color.Snow);
		...
		public static readonly IMaterial Slime = new Material(Utils.MapColor.Green).SetTranslucent().WithSlipperiness(0.8d);
		...
		public static readonly IMaterial ReplaceableWaterPlant = new Material(Utils.MapColor.Water).SetReplaceable().SetWaterLoggable();
		...
		public IMaterial WithMapColor(IMapColor color)
		{
			MapColor = color;
			return this;
		}
