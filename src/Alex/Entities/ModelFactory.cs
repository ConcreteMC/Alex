...
namespace Alex.Entities
{
        public static class ModelFactory
        {
            public static bool TryGetModel(string geometry, out EntityModel model)
            {
				...
				if (geometry.Equals("geometry.guardian")) { model = new Models.GuardianModel(); return true; }
				...
				if (geometry.Equals("geometry.cow")) { model = new Models.CowModel(); return true; }
				if (geometry.Equals("geometry.pig")) { model = new Models.PigModel(); return true; }
				if (geometry.Equals("definition.vex")) { model = new Models.VexModel(); return true; }
				...
				if (geometry.Equals("geometry.llama")) { model = new Models.LlamaModel(); return true; }
				...
				if (geometry.Equals("definition.boat")) { model = new Models.BoatModel(); return true; }
				if (geometry.Equals("definition.husk")) { model = new Models.HuskModel(); return true; }
				if (geometry.Equals("geometry.ocelot")) { model = new Models.OcelotModel(); return true; }
				if (geometry.Equals("geometry.parrot")) { model = new Models.ParrotModel(); return true; }
				if (geometry.Equals("geometry.rabbit")) { model = new Models.RabbitModel(); return true; }
				...
				if (geometry.Equals("geometry.spider")) { model = new Models.SpiderModel(); return true; }
				if (geometry.Equals("geometry.turtle")) { model = new Models.TurtleModel(); return true; }
				if (geometry.Equals("definition.sheep")) { model = new Models.SheepModel(); return true; }
				if (geometry.Equals("definition.skull")) { model = new Models.SkullModel(); return true; }
				if (geometry.Equals("definition.stray")) { model = new Models.StrayModel(); return true; }
				if (geometry.Equals("definition.witch")) { model = new Models.WitchModel(); return true; }
				if (geometry.Equals("geometry.chicken")) { model = new Models.ChickenModel(); return true; }
				if (geometry.Equals("geometry.creeper")) { model = new Models.CreeperModel(); return true; }
				...
				if (geometry.Equals("geometry.shulker")) { model = new Models.ShulkerModel(); return true; }
				if (geometry.Equals("definition.evoker")) { model = new Models.EvokerModel(); return true; }
				if (geometry.Equals("definition.wither")) { model = new Models.WitherModel(); return true; }
				if (geometry.Equals("definition.zombie")) { model = new Models.ZombieModel(); return true; }
				if (geometry.Equals("geometry.cow.v1.8")) { model = new Models.CowV18Model(); return true; }
				if (geometry.Equals("geometry.enderman")) { model = new Models.EndermanModel(); return true; }
				...
				if (geometry.Equals("geometry.skeleton")) { model = new Models.SkeletonModel(); return true; }
				if (geometry.Equals("geometry.vex.v1.8")) { model = new Models.VexV18Model(); return true; }
				if (geometry.Equals("geometry.villager")) { model = new Models.VillagerModel(); return true; }
				if (geometry.Equals("definition.drowned")) { model = new Models.DrownedModel(); return true; }
				...
				if (geometry.Equals("geometry.mooshroom")) { model = new Models.MooshroomModel(); return true; }
				if (geometry.Equals("geometry.polarbear")) { model = new Models.PolarbearModel(); return true; }
				if (geometry.Equals("geometry.snowgolem")) { model = new Models.SnowgolemModel(); return true; }
				if (geometry.Equals("definition.minecart")) { model = new Models.MinecartModel(); return true; }
				...
				if (geometry.Equals("geometry.vindicator")) { model = new Models.VindicatorModel(); return true; }
				...
				if (geometry.Equals("geometry.stray.armor")) { model = new Models.StrayArmorModel(); return true; }
				...
				if (geometry.Equals("definition.magma_cube")) { model = new Models.MagmaCubeModel(); return true; }
				if (geometry.Equals("definition.pufferfish")) { model = new Models.PufferfishModel(); return true; }
				if (geometry.Equals("geometry.shulker.v1.8")) { model = new Models.ShulkerV18Model(); return true; }
				if (geometry.Equals("definition.cave_spider")) { model = new Models.CaveSpiderModel(); return true; }
				...
				if (geometry.Equals("geometry.illager_beast")) { model = new Models.IllagerBeastModel(); return true; }
				if (geometry.Equals("geometry.sheep.sheared")) { model = new Models.SheepShearedModel(); return true; }
				...
				if (geometry.Equals("definition.ender_dragon")) { model = new Models.EnderDragonModel(); return true; }
				if (geometry.Equals("definition.tropicalfish")) { model = new Models.TropicalfishModel(); return true; }
				if (geometry.Equals("geometry.mooshroom.v1.8")) { model = new Models.MooshroomV18Model(); return true; }
				if (geometry.Equals("geometry.pufferfish.mid")) { model = new Models.PufferfishMidModel(); return true; }
				if (geometry.Equals("geometry.snowgolem.v1.8")) { model = new Models.SnowgolemV18Model(); return true; }
				if (geometry.Equals("geometry.skeleton.stray")) { model = new Models.SkeletonStrayModel(); return true; }
				...
				if (geometry.Equals("definition.zombie_pigman")) { model = new Models.ZombiePigmanModel(); return true; }
				if (geometry.Equals("geometry.creeper.charged")) { model = new Models.CreeperChargedModel(); return true; }
				if (geometry.Equals("geometry.vindicator.v1.8")) { model = new Models.VindicatorV18Model(); return true; }
				if (geometry.Equals("geometry.skeleton.wither")) { model = new Models.SkeletonWitherModel(); return true; }
				if (geometry.Equals("geometry.zombie.husk.v1.8")) { model = new Models.ZombieHuskV18Model(); return true; }
				if (geometry.Equals("geometry.pufferfish.small")) { model = new Models.PufferfishSmallModel(); return true; }
				if (geometry.Equals("geometry.pufferfish.large")) { model = new Models.PufferfishLargeModel(); return true; }
				if (geometry.Equals("geometry.stray.armor.v1.8")) { model = new Models.StrayArmorV18Model(); return true; }
				if (geometry.Equals("geometry.witherBoss.armor")) { model = new Models.WitherbossArmorModel(); return true; }
				if (geometry.Equals("definition.wither_skeleton")) { model = new Models.WitherSkeletonModel(); return true; }
				if (geometry.Equals("definition.zombie_villager")) { model = new Models.ZombieVillagerModel(); return true; }
				...
				if (geometry.Equals("geometry.evoker")) { model = new Models.EvokerGeometryVillagerModel(); return true; }
				...
				if (geometry.Equals("geometry.villager.witch")) { model = new Models.VillagerWitchGeometryVillagerModel(); return true; }
