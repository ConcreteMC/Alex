...
namespace Alex.Entities.Models 
{
	...
	public partial class PufferfishLargeV18Model : OldEntityModel
	{
		public PufferfishLargeV18Model()
		{
			Name = "geometry.pufferfish.large.v1.8";
			...
			Bones = new EntityModelBone[15]
			{
				...
				new EntityModelBone(){ 
					...
					Rotation = new Vector3(0f,0f,0f),
					BindPoseRotation = new Vector3(45f,0f,0f),
					NeverRender = false,
					Mirror = false,
					Reset = false,
					Cubes = new EntityModelCube[1]{
				...
				new EntityModelBone(){ 
					...
					Rotation = new Vector3(0f,0f,0f),
					BindPoseRotation = new Vector3(0f,45f,0f),
					NeverRender = false,
					Mirror = false,
					Reset = false,
					Cubes = new EntityModelCube[1]{
