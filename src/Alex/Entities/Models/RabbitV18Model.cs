...
namespace Alex.Entities.Models 
{
	...
	public partial class RabbitV18Model : OldEntityModel
	{
		public RabbitV18Model()
		{
			...
			Bones = new EntityModelBone[12]
			{
				...
				new EntityModelBone(){ 
					...
					Pivot = new Vector3(3f,6.5f,3.7f),
					Rotation = new Vector3(0f,0f,0f),
					BindPoseRotation = new Vector3(-20f,0f,0f),
					NeverRender = false,
					Mirror = true,
					Reset = false,
					Cubes = new EntityModelCube[1]{
				...
				new EntityModelBone(){ 
					...
					Rotation = new Vector3(0f,0f,0f),
					BindPoseRotation = new Vector3(-10f,0f,0f),
					NeverRender = false,
					Mirror = true,
					Reset = false,
					Cubes = new EntityModelCube[1]{
				...
				new EntityModelBone(){ 
					...
					Pivot = new Vector3(0f,8f,-1f),
					Rotation = new Vector3(0f,0f,0f),
					BindPoseRotation = new Vector3(0f,-15f,0f),
					NeverRender = false,
					Mirror = true,
					Reset = false,
					Cubes = new EntityModelCube[1]{
