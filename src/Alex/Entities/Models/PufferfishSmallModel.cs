...
namespace Alex.Entities.Models 
{
	...
	public partial class PufferfishSmallModel : OldEntityModel
	{
		public PufferfishSmallModel()
		{
			Name = "geometry.pufferfish.small";
			...
			Bones = new EntityModelBone[4]
			{
				...
				new EntityModelBone(){ 
					...
					Cubes = new EntityModelCube[1]{
						new EntityModelCube()
						{
							Origin = new Vector3(1.5f,0f,-1.4904f),
				...
				new EntityModelBone(){ 
					...
					Cubes = new EntityModelCube[1]{
						new EntityModelCube()
						{
							Origin = new Vector3(-2.4968f,0f,-1.492f),
							Size = new Vector3(1f, 1f, 2f),
							Uv = new Vector2(25f, 0f)
						},
					}
