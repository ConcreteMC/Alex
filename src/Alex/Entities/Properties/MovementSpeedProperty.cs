...
namespace Alex.Entities.Properties
{
	public class MovementSpeedProperty : EntityProperty
	{
		...
		public MovementSpeedProperty(double value = 0.699999988079071, Modifier[] modifiers = null) : this(
			null, value, modifiers) { }

		public MovementSpeedProperty(Entity entity, double value = 0.699999988079071, Modifier[] modifiers = null) :
			base(EntityProperties.MovementSpeed, value, modifiers)
		{
			_entity = entity;
		}

		protected MovementSpeedProperty(string key,
			Entity entity,
			double value = 0.699999988079071,
			Modifier[] modifiers = null) : base(key, value, modifiers)
		{
			_entity = entity;
		}
