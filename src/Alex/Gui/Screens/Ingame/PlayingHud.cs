...
namespace Alex.Gui.Screens.Ingame
{
	public class PlayingHud : Screen, IChatRecipient
	{
			...
			NetworkProvider networkProvider) : base()
		{
			...
			{
				Orientation = Orientation.Vertical, ChildAnchor = Alignment.Fill
			};
			...
			Scoreboard = new ScoreboardView() { Anchor = Alignment.MiddleRight, Margin = new Thickness(0, 5, 0, 0) };
			...
			{
				Orientation = Orientation.Vertical, Anchor = Alignment.FillRight, ChildAnchor = Alignment.Default
			};
