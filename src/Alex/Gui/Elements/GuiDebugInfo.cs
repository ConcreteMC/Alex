...
namespace Alex.Gui.Elements
{
	public class GuiDebugInfo : Screen
	{
		...
		{
			AddChild(
				_leftContainer = new StackContainer()
				{
					Orientation = Orientation.Vertical, Anchor = Alignment.TopLeft, ChildAnchor = Alignment.TopLeft,
				});

			AddChild(
				_rightContainer = new StackContainer()
				{
