	...
	public abstract class GuiContext3DElement : RocketElement
	{
		...
		protected sealed override void OnDraw(GuiSpriteBatch graphics, GameTime gameTime)
		{
			...
			if (_canRender)
			{
				...
				using (var context = graphics.BranchContext(
					       BlendState.Opaque, DepthStencilState.Default, RasterizerState.CullClockwise,
		...
		protected sealed override void OnUpdate(GameTime gameTime)
		{
			...
			if (_canRender)
			{
				...
				{
					GraphicsDevice = Alex.Instance.GraphicsDevice, GameTime = gameTime, Camera = Camera
				};
		...
		public class GuiContext3DCamera : Camera
		{
			...
			protected override void UpdateViewMatrix()
			{
				...
				ViewMatrix = Matrix.CreateLookAt(
					Target + CameraPositionOffset, Target + TargetPositionOffset, Vector3.Up);
			}
			...
			public override void UpdateProjectionMatrix()
			{
				...
				ProjectionMatrix = Matrix.CreatePerspectiveFieldOfView(
					MathHelper.ToRadians(FieldOfView), Viewport.AspectRatio, NearDistance, FarDistance);
			}
