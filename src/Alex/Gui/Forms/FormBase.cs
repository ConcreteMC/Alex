...
namespace Alex.Gui.Forms
{
	public class FormBase : DialogBase
	{
		...
		{
			return text.Replace(TextColor.Gray.ToString(), TextColor.White.ToString())
			   .Replace(TextColor.DarkGray.ToString(), TextColor.White.ToString()).Replace(
					TextColor.Black.ToString(), TextColor.White.ToString());
		}
