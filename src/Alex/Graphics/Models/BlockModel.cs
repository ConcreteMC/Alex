...
namespace Alex.Graphics.Models
{
    public class BlockModel : Model
	{
		...
		protected VertexPositionNormalTextureColor[] GetQuadVertices(BlockFace blockFace, Vector3 startPosition, Vector3 endPosition, UVMap uvmap, int rotation = 0)
		{
			...
			switch (blockFace)
			{
				...
				case BlockFace.North: //Negative Z
					textureTopLeft = VectorExtension.From(endPosition, endPosition, endPosition);
					textureTopRight = VectorExtension.From(startPosition, endPosition, endPosition);

					textureBottomLeft = VectorExtension.From(endPosition, startPosition, endPosition);
					textureBottomRight = VectorExtension.From(startPosition, startPosition, endPosition);
