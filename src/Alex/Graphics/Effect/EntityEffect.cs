...
namespace Alex.Graphics.Effect
{
	public class EntityEffect : Microsoft.Xna.Framework.Graphics.Effect, IEffectMatrices, IEffectFog
	{
		...
		private static void SetFogVector(ref Matrix worldView,
			float fogStart,
			float fogEnd,
		...
		protected override void OnApply()
		{
			...
			_dirtyFlags = SetWorldViewProjAndFog(
				...
				_worldParam, _viewParam, _projParam, _fogStartParam, _fogEndParam, _fogEnabledParam, _fogColorParam,
				FogColor);
