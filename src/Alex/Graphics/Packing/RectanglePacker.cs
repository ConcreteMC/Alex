...
internal class ArevaloRectanglePacker : RectanglePacker
{
	...
	public ArevaloRectanglePacker(int packingAreaWidth, int packingAreaHeight) : base(
		packingAreaWidth, packingAreaHeight) { }
	...
	public override bool TryPack(int rectangleWidth, int rectangleHeight, out Point placement)
	{
		...
		int anchorIndex = SelectAnchorRecursive(
			rectangleWidth, rectangleHeight, actualPackingAreaWidth, actualPackingAreaHeight);
		...
		bool blocksAnchor = ((placement.X + rectangleWidth) > anchors[anchorIndex].X)
	...
	/// </returns>
	private int SelectAnchorRecursive(int rectangleWidth,
		int rectangleHeight,
		...
		int testedPackingAreaHeight)
	{
		...
		if (canEnlargeHeight && shouldEnlargeHeight)
		{
			...
			return SelectAnchorRecursive(
				rectangleWidth, rectangleHeight, testedPackingAreaWidth,
		...
		if (canEnlargeWidth)
		{
			...
			return SelectAnchorRecursive(
				rectangleWidth, rectangleHeight, Math.Min(testedPackingAreaWidth * 2, PackingAreaWidth),
	...
	private int FindFirstFreeAnchor(int rectangleWidth,
		int rectangleHeight,
		int testedPackingAreaWidth,
		int testedPackingAreaHeight)
	{
	...
	private bool IsFree(ref Rectangle rectangle, int testedPackingAreaWidth, int testedPackingAreaHeight)
	{
		...
		bool leavesPackingArea = (rectangle.X < 0) || (rectangle.Y < 0) || (rectangle.Right > testedPackingAreaWidth)
