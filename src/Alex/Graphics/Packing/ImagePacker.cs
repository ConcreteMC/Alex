...
namespace Alex.Graphics.Packing;
    ...
    public class ImagePacker
    {
        ...
        private readonly Dictionary<ResourceLocation, Image<Rgba32>> bitmaps = new Dictionary<ResourceLocation, Image<Rgba32> >();
        private readonly Dictionary<ResourceLocation, Rectangle> imagePlacement = new Dictionary<ResourceLocation, Rectangle>();
            ...
            out Dictionary<ResourceLocation, Sprite> outputMap)
        {
            ...
            for (var index = 0; index < fileArray.Length; index++)
            {
                ...
                progressReceiver?.UpdateProgress(index, fileArray.Length, "Pre-Processing...", image.ResourceLocation.ToString());
        ...
        private bool TestPackingImages(IProgressReceiver progressReceiver, int testWidth, int testHeight, Dictionary<ResourceLocation, Rectangle> testImagePlacement)
        {
            ...
            for (var index = 0; index < files.Count; index++)
            {
                ...
                testImagePlacement.Add(
                    image.ResourceLocation,
                    new Rectangle(origin.X, origin.Y, size.Width + padding, size.Height + padding));
            }
        ...
        private Image<Rgba32> CreateOutputImage(IProgressReceiver progressReceiver)
        {
            ...
            progressReceiver?.UpdateProgress(
                0, files.Count, "Packing textures...");
