...
namespace Alex.Gamestates.InGame
{
	public class PlayingState : GameState
	{
		...
		private void InitDebugInfo()
		{
			...
			_debugInfo.AddDebugLeft(() => $"Primitives: {Alex.GraphicsDevice.Metrics.PrimitiveCount:N0} Draw count: {Alex.GraphicsDevice.Metrics.DrawCount}", TimeSpan.FromMilliseconds(500));
