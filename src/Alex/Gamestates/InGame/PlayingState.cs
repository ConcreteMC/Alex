	...
	public class PlayingState : GameState
	{
		...
		private void InitDebugInfo()
		{
			...
			_debugInfo.AddDebugLeft(() =>
			{
				...
				return $"Velocity: (X={pos.X:F2}, Y={pos.Y:F2}, Z={pos.Z:F2}) ({World.Player.Movement.MetersPerSecond:F3} m/s) ({World.Player.Movement.BlocksPerTick:F3} m/t) ({World.Player.Movement.RawSpeed:F3})";// / Target Speed: {(World.Player.CalculateMovementSpeed() * 20f):F3} m/s";
			});
