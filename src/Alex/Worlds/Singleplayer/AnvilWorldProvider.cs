...
namespace Alex.Worlds.Singleplayer
{
	...
	//	public Queue<Block> LightSources { get; set; } = new Queue<Block>();
		...
		private void ReadSection(NbtTag sectionTag, ChunkColumn chunk, bool convertBid = true)
		{
			...
			var section = new ChunkSection(chunk, ReadSkyLight);
		...
		private void ReadOldSection(NbtTag sectionTag, ChunkColumn chunk, bool convertBid = true)
		{
