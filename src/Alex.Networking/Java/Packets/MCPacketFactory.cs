...
namespace Alex.Networking.Java.Packets
{
	public static class MCPacketFactory
	{
		...
		private static void RegisterPlay()
		{
			...
			Register(Direction.ClientBound, ConnectionState.Play, 0x3E, () => new HeldItemChangePacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x2F, () => new PlayerAbilitiesPacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x31, () => new PlayerListItemPacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x33, () => new PlayerPositionAndLookPacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x4B, () => new TimeUpdatePacket());
			...
			Register(Direction.ClientBound, ConnectionState.Play, 0x3A, () => new EntityHeadLook());
			Register(Direction.ClientBound, ConnectionState.Play, 0x40, () => new EntityMetadataPacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x42, () => new EntityVelocity());
			Register(Direction.ClientBound, ConnectionState.Play, 0x54, () => new EntityPropertiesPacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x52, () => new EntityTeleport());
			...
			Register(Direction.ClientBound, ConnectionState.Play, 0x58, () => new UpdateLightPacket());
			...
			Register(Direction.ClientBound, ConnectionState.Play, 0x30, () => new CombatEventPacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x24, () => new ParticlePacket());
			Register(Direction.ClientBound, ConnectionState.Play, 0x43, () => new EntityEquipmentPacket());
