...
namespace Alex.ResourcePackLib.Json.Models
{
	...
	public class ResourcePackModelBase
	{
		...
		/// </summary>
		[JsonProperty("parent")] public ResourceLocation ParentName;
		...
		public Dictionary<string, DisplayElement> Display { get; } =
			new Dictionary<string, DisplayElement>(StringComparer.OrdinalIgnoreCase)
			{
				{
					"gui",
					new DisplayElement(
