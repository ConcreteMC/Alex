...
namespace Alex.ResourcePackLib.Json.BlockStates
{
	public class BlockStateResource
	{
		...
		/// </summary>
		public Dictionary<BlockVariantKey, BlockStateVariant> Variants { get; set; } =
			new Dictionary<BlockVariantKey, BlockStateVariant>();

		[JsonProperty("multipart")] public BlockStateMultiPart[] Parts { get; set; } = new BlockStateMultiPart[0];
	}
