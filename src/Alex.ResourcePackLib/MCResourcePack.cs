...
namespace Alex.ResourcePackLib
{
	public class McResourcePack : ResourcePack, ITextureProvider, IBlockStateResourceProvider, IDisposable
	{
		...
		private static readonly Regex IsLanguageResource    = new(@"^((?'namespace'.*)(?<!realms))[\\\/]lang[\\\/](?'filename'.*)[\\.](?'filetype'json|lang)$", RegexOpts);
		private static readonly Regex IsFontTextureResource = new(@"^(?'namespace'.*)[\\\/]textures[\\\/]font[\\\/](?'filename'.*)\.png$", RegexOpts);
		private static readonly Regex IsTextureResource     = new(@"^(?'namespace'.*)[\\\/]textures[\\\/](?'filename'.*)\.png$", RegexOpts);
		private static readonly Regex IsTextureMetaResource = new(@"^(?'namespace'.*)[\\\/]textures[\\\/](?'filename'.*)\.png.mcmeta$", RegexOpts);
		private static readonly Regex IsModelRegex          = new(@"^(?'namespace'.*)[\\\/]models[\\\/](?'filename'.*)\.json$", RegexOpts);
		private static readonly Regex IsBlockStateRegex     = new(@"^(?'namespace'.*)[\\\/]blockstates[\\\/](?'filename'.*)\.json$", RegexOpts);
		private static readonly Regex IsGlyphSizes          = new(@"^(?'namespace'.*)[\\\/]font[\\\/]glyph_sizes.bin$", RegexOpts);
		private static readonly Regex IsFontDefinition      = new(@"^(?'namespace'.*)[\\\/]font[\\\/](?'filename'.*)\.json$", RegexOpts);
		private static readonly Regex IsParticle            = new(@"^(?'namespace'.*)[\\\/]particles[\\\/](?'filename'.*)\.json$", RegexOpts);
		private static readonly Regex IsSoundDefinition     = new(@"^(?'namespace'.*)[\\\/]sounds.json$", RegexOpts);
